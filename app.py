...
# ✅ Define genre_options globally (Fixing the NameError)
genre_options = ["Fiction", "Non-Fiction", "Science Fiction", "Biography", "Self-Help", 
                 "Mystery", "Romance", "Fantasy", "Horror", "Thriller", "History", "Other"]
